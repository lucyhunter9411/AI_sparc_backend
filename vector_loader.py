...
DB_IMAGE_FAISS_PATH = "vectorstore/image_faiss"
IMAGE_DIR = "images"
os.makedirs(IMAGE_DIR, exist_ok=True) 


# Embed Text from PDFs
pdf_files = ["./ref_1.pdf", "./ref_2.pdf"]
all_splits = []
...
print(f"Text embeddings saved to {DB_TEXT_FAISS_PATH}")
...
print(f"Image description embeddings saved to {faiss_path}")
